...
const MissionIcon: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-rose-500 dark:text-rose-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>;
const RequirementsIcon: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-rose-500 dark:text-rose-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>;
const TechStackIcon: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-rose-500 dark:text-rose-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>;
const StretchGoalIcon: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-rose-500 dark:text-rose-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>;
            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="flex justify-center items-center mb-4">
                        <GeneratorIcon />
                        <h2 className="text-3xl md:text-4xl font-extrabold text-rose-900 dark:text-rose-100">Weekend Project Generator</h2>
                    </div>
                    ...
                    <button
                        ...
                        className="mt-8 px-8 py-4 bg-rose-400 text-white font-semibold rounded-full shadow-lg hover:shadow-xl hover:bg-rose-50 dark:bg-slate-8000 transition-all transform hover:scale-105 active:scale-95 duration-300"
                    >
                ...
                {currentProject && (
                    <div className="mt-12 max-w-4xl mx-auto bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-8 border border-lime-200 dark:border-slate-700 transform transition-all duration-500 ease-out scale-95 opacity-0 animate-fade-in-scale" style={{ animationFillMode: 'forwards' }}>
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-xl font-bold text-rose-900 dark:text-rose-100 flex items-center"><MissionIcon /> Your Mission</h3>
                                <p className="text-2xl text-rose-700 mt-1">{currentProject.mission}</p>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-semibold text-rose-800 dark:text-rose-200 flex items-center mb-2"><RequirementsIcon /> Core Requirements</h4>
                                    <ul className="list-disc list-inside text-rose-600 dark:text-rose-300 space-y-1">
                                        {currentProject.requirements.map((req, i) => <li key={i}>{req}</li>)}
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-rose-800 dark:text-rose-200 flex items-center mb-2"><TechStackIcon /> Suggested Tech Stack</h4>
                            ...
                            <div>
                                <h4 className="font-semibold text-rose-800 dark:text-rose-200 flex items-center mb-2"><StretchGoalIcon /> Stretch Goal</h4>
                                <p className="text-rose-600 dark:text-rose-300">{currentProject.stretchGoal}</p>
                            </div>
                        </div>

                        <div className="mt-8 pt-6 border-t border-lime-200 dark:border-slate-700 text-center">
