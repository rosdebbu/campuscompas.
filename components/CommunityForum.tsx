...
const CommunityForum: React.FC = () => {
    ...
    const renderLeaders = () => {
        ...
        return (
            <div className="w-full h-full grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 overflow-y-auto custom-scrollbar p-2">
    ...
    return (
        <section className="py-12 md:py-24 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
