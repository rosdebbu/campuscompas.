    ...
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4">
                <div className="bg-lime-50 rounded-2xl shadow-lg p-8 text-center border border-lime-200 max-w-4xl mx-auto">
                    <div className="flex justify-center items-center mb-4">
                        <CodeExplainerIcon />
                        <h2 className="text-3xl md:text-4xl font-extrabold text-rose-900">AI Code Explainer</h2>
                    </div>
                    ...
                    <a
                        ...
                        className="mt-8 inline-block px-8 py-4 bg-rose-400 text-white font-semibold rounded-full shadow-lg hover:shadow-xl hover:bg-rose-500 transition-all transform hover:scale-105 active:scale-95 duration-300"
                    >
